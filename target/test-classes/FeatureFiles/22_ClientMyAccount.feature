Feature: Client My Account Functionalities
  #MyProfile
  @Profile @Regression
  Scenario: Verify that the client can edit their profile
  ...
  Scenario: Verify that the client can add their secondary email
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  Scenario: Verify that the client cannot add empty secondary email
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the Add Email button
  ...
  Scenario: Verify that the client cannot add invalid secondary email
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the Add Email button
  ...
  Scenario: Verify that the client can delete secondary email
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  Scenario: Verify that the client can add secondary phonenumber
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  Scenario: Verify that the client cannot add empty secondary phonenumber
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the Add mobile number button
  ...
  Scenario: Verify that the client cannot add morethan 10digit secondary phonenumber
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the Add mobile number button
  ...
  Scenario: Verify that the client can able to delete the secondary phonenumber
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the delete button and confirm the action
  ...
  Scenario: Verify that the client can set the primary email
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  #Security
  @Password @Regression
  Scenario: Verify that the client can set the password
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  Scenario: Verify that the client cannot set the wrong password
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the security sidemenu
  ...
  #Sessions
  @Sessions @Regression
  Scenario: Verify that the client can terminate the previous session
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
  ...
  Scenario: Verify that the client can terminate all the session
    Given the client logs in using valid credentials
    When the user clicks on the profile and selects the My Account option
    And the user navigates to a new tab
    And the user clicks the Sessions sidemenu
