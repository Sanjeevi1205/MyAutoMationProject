...
@Getter
public class ClientRetainerInviocePOM extends LibGlobal{
	public ClientRetainerInviocePOM() {
	...
	@FindBy(xpath = "//span[text()='Retainer Invoices']")
	private WebElement retainerInvioce;
